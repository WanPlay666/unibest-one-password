...
function handleClick(index: number) {
  // 点击鼓包tabbarItem，直接调用 handleClickBulge，不做页面跳转
...
<template>
  <view v-if="customTabbarEnable" class="border-and-fixed b-0 b-t-1 border-white/10 b-solid" @touchmove.stop.prevent>

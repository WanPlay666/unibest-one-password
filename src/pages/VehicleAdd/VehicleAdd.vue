...
const { formData, isEditMode, recordId, init, getRawData } = useFormEngine(getFormDataInitial('vehicle'))
...
const currentCategory = computed(() => CATEGORY_MAP[categoryId.value] || CATEGORY_MAP['5'])
